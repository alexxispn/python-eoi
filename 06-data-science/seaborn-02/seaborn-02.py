...
def example7():
    ...
    g.map(plt.hist, "age")
    save_plot('example07.png')


def example8():
    sns.catplot(x="pclass", y="age", hue="sex", kind="swarm", data=titanic)
    save_plot('example08.png')


def example9():
    sns.jointplot(x="fare", y="age", data=titanic)
    save_plot('example09.png')
